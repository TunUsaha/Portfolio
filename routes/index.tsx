        ...
        <section className='grid grid-2'>
          <div className='autoShow'>
            ...
            <p>
              ...
              challenges, particularly through the Sustainable Innovation Camp
              with Singapore Polytechnic. This camp allowed me to apply Design
              Thinking to create sustainable solutions for communities in Chiang
              Mai and Lamphun. My interests include blending creativity with
              data analytics to solve complex problems.
            </p>
          </div>

          <div className='autoShow'>
            <p>
              Cybersecurity is one of my key interests in the digital world. I
              am fascinated by the field's dynamic nature and the ongoing
              challenges of securing information and systems. My passion for
              cybersecurity aligns with my desire to make the digital world
              safer for individuals and businesses alike.
            </p>
          </div>
          ...
          <div className='autoShow'>
            ...
            <p>
              ...
              datasets and experimenting with various machine learning
